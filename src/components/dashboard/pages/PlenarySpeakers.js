...
const SEED = [
    ...
    { id: 2, name: 'Prof. Robert Lee', title: 'Head of Environmental Sciences', affiliation: 'National University of Singapore', country: 'Singapore', image: null, bio: 'Prof. Robert Lee leads groundbreaking research on climate adaptation strategies and renewable transition.' },
];
