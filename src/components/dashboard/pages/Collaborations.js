...
export default function Collaborations() {
    ...
    const loadData = async () => {
        setLoading(true);
        try {
            const data = await getSponsors('collaboration');
            if (data) {
    ...
    if (loading) return <div className="mp-loading">Loading collaborations...</div>;

    return (
        <div className="mp-page">
            <div style={showAdd ? { filter: 'blur(4px)', pointerEvents: 'none' } : {}}>
                <div className="mp-page-header">
                    <h1 className="mp-title">Collaborations</h1>
                    <p className="mp-subtitle">Manage institutional, university, and partner collaborations</p>
                </div>

                <div className="mp-toolbar-row">
                    <div className="mp-actions-left">
                        <button className="mp-add-btn" onClick={openAdd}>
                            Add New Collaboration <Plus size={16} />
                        </button>
                                        ...
                                        <td className="mp-td" style={{ textAlign: 'center' }}>
                                            {editingId === row.id ? (
                                                ...
                                                <div className="mp-action-btns">
                                                    ...
                                                    <button className="mp-icon-btn mp-delete" onClick={() => deleteRow(row.id)}><Trash2 size={16} /></button>
                                                </div>
                                            )}
                                        </td>
                                    </tr>
                ...
                <div className="mp-modal-overlay">
                    <div className="mp-modal">
                        ...
                        <div className="mp-modal-footer">
                            ...
                            <button className="mp-modal-save" onClick={saveAdd}><Save size={14}/> Save</button>
                        </div>
                    </div>
                </div>
            )}
