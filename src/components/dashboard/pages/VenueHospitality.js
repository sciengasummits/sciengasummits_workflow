...
/* â”€â”€ Save/restore browser selection â”€â”€ */
...
export default function VenueHospitality() {
    ...
    const DEFAULT_HTML = `<p>Rome, the "Eternal City," brims with ancient history, from the Colosseum to the port of Ostia Antica to majestic Vatican City and the Sistine Chapel. Because of its history, art, architecture, and beauty â€“ and perhaps its gelato and pasta! â€“ Rome is one of our most popular cities.</p>
