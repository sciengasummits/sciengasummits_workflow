...
const EMPTY_FORM = { name: '', affiliation: '', country: '', link: '' };
...
export default function OrganizingCommittee({ conf }) {
    ...
    const openEdit = (m) => { setForm({ name: m.name, affiliation: m.affiliation, country: m.country, link: m.link || '' }); setModal({ mode: 'edit', id: m.id }); };
                                ...
                                >
                                    ...
                                    <td className="oc-td oc-td-name">
                                        <div className="oc-user-cell">
                                            ...
                                            {m.link ? (
                                                <a href={m.link} target="_blank" rel="noopener noreferrer" className="oc-name-link" style={{ textDecoration: 'none', color: '#3b82f6', fontWeight: 600 }}>{m.name}</a>
                                            ) : (
                ...
                <div className="oc-modal-overlay" onClick={closeModal}>
                    <div className="oc-modal" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="oc-modal-body">
                            ...
                            />
                            <label className="oc-label">Site Link (Optional)</label>
                            <input
                                className="oc-input"
